 ...
 */
class SA_RIBBON_EXPORT SAWindowToolButton : public QPushButton
{
    Q_OBJECT
public:
...
/**
 * @brief The SAWindowToolWidget class
 */
class SA_RIBBON_EXPORT SAWindowToolWidget : public QWidget
{
    Q_OBJECT
public:
    SAWindowToolWidget(QWidget* p = nullptr);
    //~SAWindowToolWidget();
};
