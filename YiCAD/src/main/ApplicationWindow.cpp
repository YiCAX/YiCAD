...
{
	if (m_pTabDrawWidget->getCurrentMdiWindow() == nullptr)
	{
		return;
	}

	// 绘图区域
	m_pDrawingArea->resize(this->width(), this->height() - 215);
	m_pCurrentMdiWin->resize(m_pDrawingArea->size());
	m_pTabDrawWidget->getBackTabDrawWidget()->setFixedWidth(m_pDrawingArea->width());
...
void ApplicationWindow::createCategoryFile(SARibbonCategory* page)
{
	...
	SARibbonButtonGroupWidget* fileGroup = new SARibbonButtonGroupWidget(pannel1, 1);

	// 新建文件
	QToolButton* btnNew = new QToolButton();
	btnNew->setIcon(QIcon(":/ribbon/file/new.svg"));
	btnNew->setToolTip(QObject::tr("new"));
	btnNew->setIconSize(QSize(35, 35));
	btnNew->setMinimumSize(40, 55);
	...
	btnOpen->setIconSize(QSize(35, 35));
	btnOpen->setMinimumSize(40, 55);
	...
	btnSaveAs->setIconSize(QSize(35, 35));
	btnSaveAs->setMinimumSize(40, 55);
	...
	//btnSaveAll->setStyleSheet(qss);
	//btnSaveAll->setIconSize(QSize(35, 35));
	//btnSaveAll->setMinimumSize(40, 55);
	...
	fileGroup->setMinimumHeight(70);
	pannel1->addLargeWidget(fileGroup);


	SARibbonPannel* pannel2 = page->addPannel(QObject::tr("Export"));

	//SARibbonButtonGroupWidget* importGroup = new SARibbonButtonGroupWidget(pannel2, 1);
	...
	//btnImportImage->setStyleSheet(qss);
	//btnImportImage->setIconSize(QSize(35, 35));
	//btnImportImage->setMinimumSize(40, 55);
	...
	//btnImportBlock->setStyleSheet(qss);
	//btnImportBlock->setIconSize(QSize(35, 35));
	//btnImportBlock->setMinimumSize(40, 55);
	...
	//importGroup->setMinimumHeight(70);
	//pannel2->addLargeWidget(importGroup);

	SARibbonButtonGroupWidget* exportGroup = new SARibbonButtonGroupWidget(pannel2, 1);
	...
	btnExportImage->setIconSize(QSize(35, 35));
	btnExportImage->setMinimumSize(40, 55);
	...
	//btnExportPDF->setStyleSheet(qss);
	//btnExportPDF->setIconSize(QSize(35, 35));
	//btnExportPDF->setMinimumSize(40, 55);
	...
	exportGroup->setMinimumHeight(70);
	...
	//SARibbonButtonGroupWidget* printGroup = new SARibbonButtonGroupWidget(pannel3, 1);

	//// 打印
	//QToolButton* btnPrint = new QToolButton();
	//btnPrint->setIcon(QIcon(":/ribbon/file/print.svg"));
	//btnPrint->setToolTip(QObject::tr("Print"));
	//btnPrint->setStyleSheet(qss);
	//btnPrint->setIconSize(QSize(35, 35));
	//btnPrint->setMinimumSize(40, 55);
	...
	//btnPrintPreview->setStyleSheet(qss);
	//btnPrintPreview->setIconSize(QSize(35, 35));
	//btnPrintPreview->setMinimumSize(40, 55);
	...
	//printGroup->setMinimumHeight(70);
	//pannel3->addLargeWidget(printGroup);


	//SARibbonPannel* pannel4 = page->addPannel(QObject::tr("Close"));

	//SARibbonButtonGroupWidget* closeGroup = new SARibbonButtonGroupWidget(pannel4, 1);
	...
	//btnCloseAll->setStyleSheet(qss);
	//btnCloseAll->setIconSize(QSize(35, 35));
	//btnCloseAll->setMinimumSize(40, 55);
	...
	//btnQuit->setStyleSheet(qss);
	//btnQuit->setIconSize(QSize(35, 35));
	//btnQuit->setMinimumSize(40, 55);
	...
	//closeGroup->setMinimumHeight(70);
...
void ApplicationWindow::createCategoryOptions(SARibbonCategory* page)
{
	...
	SARibbonButtonGroupWidget* settingGroup = new SARibbonButtonGroupWidget(pannel1, 1);
	...
	btnApplicationSettings->setIconSize(QSize(35, 35));
	btnApplicationSettings->setMinimumSize(40, 55);
	...
	btnDrawSettings->setIconSize(QSize(35, 35));
	btnDrawSettings->setMinimumSize(40, 55);
	...
	settingGroup->setMinimumHeight(70);
	...
	//SARibbonButtonGroupWidget* aboutGroup = new SARibbonButtonGroupWidget(pannel2, 1);
	...
	//aboutGroup->setMinimumHeight(70);
...
void ApplicationWindow::createCategoryDraw2d(SARibbonCategory* page)
{
	...
	SARibbonButtonGroupWidget* lineGroup = new SARibbonButtonGroupWidget(line);
	...
	lineGroup->setMinimumHeight(70);
	line->addLargeWidget(lineGroup);

	// 曲线
	SARibbonPannel* curve = page->addPannel(QObject::tr("Curve"));
	SARibbonButtonGroupWidget* curveGroup = new SARibbonButtonGroupWidget(curve);
	...
	curveGroup->setMinimumHeight(70);
	curve->addLargeWidget(curveGroup);

	// 多段线
	SARibbonPannel* polyline = page->addPannel(QObject::tr("Polyline"));
	SARibbonButtonGroupWidget* polylineGroup = new SARibbonButtonGroupWidget(polyline);
	...
	polylineGroup->setMinimumHeight(70);
	polyline->addLargeWidget(polylineGroup);

	// 画圆
	SARibbonPannel* circle = page->addPannel(QObject::tr("Circle"));
	SARibbonButtonGroupWidget* circleGroup = new SARibbonButtonGroupWidget(circle);
	...
	circleGroup->setMinimumHeight(70);
	circle->addLargeWidget(circleGroup);

	// 椭圆
	SARibbonPannel* ellipse = page->addPannel(QObject::tr("Ellipse"));
	SARibbonButtonGroupWidget* ellipseGroup = new SARibbonButtonGroupWidget(ellipse);
	...
	ellipseGroup->setMinimumHeight(70);
	ellipse->addLargeWidget(ellipseGroup);

	// 标注
	SARibbonPannel* dimension = page->addPannel(QObject::tr("Dimension"));
	SARibbonButtonGroupWidget* dimensionGroup = new SARibbonButtonGroupWidget(dimension);
	...
	dimensionGroup->setMinimumHeight(70);
	dimension->addLargeWidget(dimensionGroup);

	// 文字
	SARibbonPannel* text = page->addPannel(QObject::tr("Text"));
	SARibbonButtonGroupWidget* textGroup = new SARibbonButtonGroupWidget(text);
	...
	textGroup->setMinimumHeight(70);
	text->addLargeWidget(textGroup);

	// 其他
	SARibbonPannel* other = page->addPannel(QObject::tr("Other"));
	SARibbonButtonGroupWidget* otherGroup = new SARibbonButtonGroupWidget(other);
	...
	otherGroup->setMinimumHeight(70);
	other->addLargeWidget(otherGroup);

	//! --- 修改 ---
	SARibbonPannel* modify = page->addPannel(QObject::tr("Modify"));
	SARibbonButtonGroupWidget* modifyGroup = new SARibbonButtonGroupWidget(modify);
	...
	modifyGroup->setMinimumHeight(70);
	modify->addLargeWidget(modifyGroup);

	// 测量
	SARibbonPannel* info = page->addPannel(QObject::tr("Measure"));
	SARibbonButtonGroupWidget* infoGroup = new SARibbonButtonGroupWidget(info);
	...
	SARibbonButtonGroupWidget* blockGroup = new SARibbonButtonGroupWidget(block);
	...
	blockGroup->setMinimumHeight(70);
...
void ApplicationWindow::createCategorySolver(SARibbonCategory* page)
{
	...
	SARibbonButtonGroupWidget* solverGroup = new SARibbonButtonGroupWidget(solver);
	...
	solverGroup->setMinimumHeight(70);
...
{
 	SARibbonButtonGroupWidget* allGroup = new SARibbonButtonGroupWidget(layerPannel);
...
ComboBoxData* ApplicationWindow::newLayer(DmLayer* layer, QListWidget* plistWidget)
{
	...
	//解决SARibbonComboBox下拉框出现空白项问题
	connect(m_pLayerTable, &SARibbonComboBox::sighide, m_pLayerTable, [this] {
					...
					for (const PluginMenuLocation& loc : pluginCapabilities.menuEntryPoints)
					{
						if (loc.isLoad)
						{
							...
							for (auto group : loc.menuGroups)
							{
								...
								SARibbonButtonGroupWidget* aboutGroup = new SARibbonButtonGroupWidget(pannel, 1);
