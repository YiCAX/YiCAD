...
/// @file MetaDimAligneds.h
/// @brief 对齐标注实体序列化容器头文件

#ifndef PERSISTENCE_META_DIMALIGNEDS_H
#define PERSISTENCE_META_DIMALIGNEDS_H
...
class MetaDimAlignedsContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param pDoc 文档指针
    MetaDimAlignedsContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaDimAlignedsContainer()
    {
    }
...
#endif // PERSISTENCE_META_DIMALIGNEDS_H
