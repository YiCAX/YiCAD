...
#ifndef PERSISTENCE_META_POINTS_H
#define PERSISTENCE_META_POINTS_H
...
class MetaPointsContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaPointsContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaPointsContainer()
	{
	}
...
#endif //PERSISTENCE_META_POINTS_H
