...
#ifndef PERSISTENCE_META_LINES_H
#define PERSISTENCE_META_LINES_H
...
class MetaLinesContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaLinesContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaLinesContainer()
	{
	}
...
#endif //PERSISTENCE_META_LINES_H
