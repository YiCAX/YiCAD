...
/// @file MetaSplines.h
/// @brief 样条线(Spline)实体序列化容器头文件

#ifndef PERSISTENCE_META_SPLINES_H
#define PERSISTENCE_META_SPLINES_H
...
class MetaSplinesContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param [in] pDoc 文档指针
    MetaSplinesContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaSplinesContainer() {};
...
#endif // PERSISTENCE_META_SPLINES_H
