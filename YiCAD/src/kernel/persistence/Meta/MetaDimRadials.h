...
/// @file MetaDimRadials.h
/// @brief 半径标注实体序列化容器头文件

#ifndef PERSISTENCE_META_DIMRADIALS_H
#define PERSISTENCE_META_DIMRADIALS_H
...
class MetaDimRadialsContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param pDoc 文档指针
    MetaDimRadialsContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaDimRadialsContainer()
    {
    }
...
#endif // PERSISTENCE_META_DIMRADIALS_H
