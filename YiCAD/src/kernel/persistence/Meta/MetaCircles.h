...
#ifndef PERSISTENCE_META_CIRCLES_H
#define PERSISTENCE_META_CIRCLES_H
...
class MetaCirclesContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaCirclesContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaCirclesContainer()
	{
	}
...
#endif //PERSISTENCE_META_CIRCLES_H
