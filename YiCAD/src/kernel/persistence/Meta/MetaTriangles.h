...
/// @file MetaTriangles.h
/// @brief 三角形(Triangle)实体序列化容器头文件

#ifndef PERSISTENCE_META_TRIANGLES_H
#define PERSISTENCE_META_TRIANGLES_H
...
class MetaTrianglesContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param [in] pDoc 文档指针
    MetaTrianglesContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaTrianglesContainer() {};
...
#endif // PERSISTENCE_META_TRIANGLES_H
