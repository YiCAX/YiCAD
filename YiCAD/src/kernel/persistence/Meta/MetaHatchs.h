...
/// @file MetaHatchs.h
/// @brief 填充(Hatch)实体序列化容器头文件

#ifndef PERSISTENCE_META_HATCHS_H
#define PERSISTENCE_META_HATCHS_H
...
class MetaHatchsContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param [in] pDoc 文档指针
    MetaHatchsContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaHatchsContainer() {};
...
#endif // PERSISTENCE_META_HATCHS_H
