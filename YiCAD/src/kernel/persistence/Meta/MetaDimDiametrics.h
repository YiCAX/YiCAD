...
/// @file MetaDimDiametrics.h
/// @brief 直径标注实体序列化容器头文件

#ifndef PERSISTENCE_META_DIMDIAMETRICS_H
#define PERSISTENCE_META_DIMDIAMETRICS_H
...
class MetaDimDiametricsContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param pDoc 文档指针
    MetaDimDiametricsContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaDimDiametricsContainer()
    {
    }
...
#endif // PERSISTENCE_META_DIMDIAMETRICS_H
