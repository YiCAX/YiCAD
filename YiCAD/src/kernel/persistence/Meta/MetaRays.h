...
#ifndef PERSISTENCE_META_RAYS_H
#define PERSISTENCE_META_RAYS_H
...
class MetaRaysContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaRaysContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaRaysContainer()
	{
	}
