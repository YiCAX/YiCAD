...
#ifndef PERSISTENCE_META_ARCS_H
#define PERSISTENCE_META_ARCS_H
...
class MetaArcsContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaArcsContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaArcsContainer()
	{
	}
