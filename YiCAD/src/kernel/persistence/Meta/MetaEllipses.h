...
#ifndef PERSISTENCE_META_ELLIPSES_H
#define PERSISTENCE_META_ELLIPSES_H
...
class MetaEllipsesContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param [in] pDoc 文档指针
	MetaEllipsesContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaEllipsesContainer()
	{
	}
...
#endif //PERSISTENCE_META_ELLIPSES_H
