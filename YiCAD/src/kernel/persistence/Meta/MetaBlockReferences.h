 ...
 */
/// @file MetaBlockReferences.h
/// @brief 块引用元数据容器头文件

#ifndef PERSISTENCE_META_BLCOKREFERENCES_H
#define PERSISTENCE_META_BLCOKREFERENCES_H
...
class MetaBlcokReferencesContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param pDoc 文档指针
	MetaBlcokReferencesContainer(DmDocument* pDoc);
...
#endif //PERSISTENCE_META_BLCOKREFERENCES_H
