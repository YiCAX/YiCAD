...
/// @file MetaTexts.h
/// @brief 单行文字实体序列化容器头文件

#ifndef PERSISTENCE_META_TEXTS_H
#define PERSISTENCE_META_TEXTS_H
...
/// 单行文字序列化容器
class MetaTextsContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param pDoc 文档指针
	MetaTextsContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaTextsContainer()
	{
	}
...
#endif //PERSISTENCE_META_TEXTS_H
