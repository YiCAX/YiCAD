...
/// @file MetaPolylines.h
/// @brief 多段线(Polyline)实体序列化容器头文件

#ifndef PERSISTENCE_META_POLYLINES_H
#define PERSISTENCE_META_POLYLINES_H
...
class MetaPolylinesContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param [in] pDoc 文档指针
    MetaPolylinesContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaPolylinesContainer() {};
...
#endif // PERSISTENCE_META_POLYLINES_H
