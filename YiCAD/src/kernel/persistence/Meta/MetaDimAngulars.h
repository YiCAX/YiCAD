...
/// @file MetaDimAngulars.h
/// @brief 角度标注实体序列化容器头文件

#ifndef PERSISTENCE_META_DIMANGULARS_H
#define PERSISTENCE_META_DIMANGULARS_H
...
class MetaDimAngularsContainer : Persistence
{
public:
    /// @brief 构造函数
    /// @param pDoc 文档指针
    MetaDimAngularsContainer(DmDocument* pDoc);

    /// @brief 析构函数
    virtual ~MetaDimAngularsContainer()
    {
    }
...
#endif // PERSISTENCE_META_DIMANGULARS_H
