 ...
 */
/// @file MetaAttributes.h
/// @brief 属性元数据容器头文件

#ifndef PERSISTENCE_META_ATTRIBUTES_H
#define PERSISTENCE_META_ATTRIBUTES_H
...
class MetaAttributesContainer : Persistence
{
public:
	/// @brief 构造函数
	/// @param pDoc 文档指针
	MetaAttributesContainer(DmDocument* pDoc);

	/// @brief 析构函数
	virtual ~MetaAttributesContainer() {};
...
#endif //PERSISTENCE_META_ATTRIBUTES_H
