...
std::string Tools::getUniqueName(const std::string& name, const std::vector<std::string>& names, int d)
{
    // find highest suffix
...
std::string Tools::addNumber(const std::string& name, unsigned int num, int d)
{
    std::stringstream str;
    str << name;
    if (d > 0) {
...
std::string Tools::getIdentifier(const std::string& name)
{
...
std::wstring Tools::widen(const std::string& str)
{
...
std::string Tools::narrow(const std::wstring& str)
{
...
// std::string Tools::escapedUnicodeFromUtf8(const char *s)
// {
...
QString Tools::escapeEncodeString(const QString& s)
{
    QString result;
...
std::string Tools::escapeEncodeString(const std::string& s)
{
    std::string result;
    size_t len = s.size();
...
QString Tools::escapeEncodeFilename(const QString& s)
{
    QString result;
    const int len = s.length();
    result.reserve(int(len * 1.1));
...
std::string Tools::escapeEncodeFilename(const std::string& s)
{
    std::string result;
    size_t len = s.size();
    for (size_t i = 0; i < len; ++i) {
...
std::vector<std::string> Tools::split_string(const std::string& s, const std::string& seperator)
{
