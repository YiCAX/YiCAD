 ...
 * @author Werner Mayer
 */
class ByteArrayIStreambuf : public std::streambuf
{
public:
 ...
 * @author Werner Mayer
 */
class IODeviceIStreambuf : public std::streambuf
{
public:
...
class Oofstream : public std::ofstream
{
public:
    Oofstream(const FileInfo& fi, ios_base::openmode mode =
...
class Oifstream : public std::ifstream
{
public:
    Oifstream(const FileInfo& fi, ios_base::openmode mode =
                                 std::ios::in)
#ifdef _MSC_VER
