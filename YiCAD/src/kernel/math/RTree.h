...
/// @file RTree.h
/// @brief RTree多维包围矩形树实现，来源：https://github.com/nushoin/RTree/tree/master

// rtree与四叉树的差别：https://qa.1r1g.com/sf/ask/1625138301/
...
public:
  ...
  public:
    ...
    DATATYPE& operator*()
    {
      ...
      return curTos.m_node->m_branch[curTos.m_branchIndex].data;
    }
...
protected:
  ...
  struct PartitionVars
  {
    ...
    int m_branchCount = 0;
    Rect m_coverSplit;
    ELEMTYPEREAL m_coverSplitArea = (ELEMTYPEREAL)0;
  };
  ...
  ELEMTYPEREAL m_unitSphereVolume = (ELEMTYPEREAL)0;         ///< Unit sphere constant for required number of dimensions
...
int RTREE_QUAL::PickBranch(const Rect* a_rect, Node* a_node)
{
  ...
  bool firstTime = true;
  ELEMTYPEREAL increase = (ELEMTYPEREAL)0;
  ELEMTYPEREAL bestIncr = (ELEMTYPEREAL)-1;
  ELEMTYPEREAL area = (ELEMTYPEREAL)0;
  ELEMTYPEREAL bestArea = (ELEMTYPEREAL)0;
  int best = 0;
  Rect tempRect;
